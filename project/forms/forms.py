...
class CompetitionForm(FlaskForm):
    ...
    fight_duration = IntegerField('Время поединка, сек')
    added_time = IntegerField('Добавленное время, сек')
...
class AgeCategoriesForm(FlaskForm):
    ...
    age_category_name_form_field = StringField('Наименование возрастной категории',
                                               validators=[validators.DataRequired()])
