...
def check_delete_weight_category(weight_cat_id):
  ...
  print("all_weight_categories_data: ", all_weight_categories_data)
  if number_of_weight_categories == 2:
    ...
    for weight_cat in all_weight_categories_data:
      ...
      print("weight_cat_id: ", weight_cat_id, "weight_cat_data: ", weight_cat, "weight_cat_name: ", weight_cat_name)
